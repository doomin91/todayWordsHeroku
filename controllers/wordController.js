...
const getWords = async function (req, res) {
    try {
        let data = {
            "startDate": `${req.params.startDate} 00:00:00`,
            "endDate": `${req.params.endDate} 23:59:59`
        }
...
const insertWord = async function (req, res) {
    try {
        ...
        let data = {
            cate: req.body.cate,
            name: req.body.name,
            relatedWords: req.body.relatedWords ? trim(JSON.stringify(req.body.relatedWords)) : "",
